...
public class RecentsGui extends GuiFrame {
        private static final Config GUI = new Config(new File(NaturalPlayerWarps.getInstance().getDataFolder(), "guis/recents.yml"),
            NaturalPlayerWarps.getInstance().getResource("guis/recents.yml"),
    ...
    public CompletableFuture<Void> load() {
        ...
        NaturalPlayerWarps.getThreadedQueue().submit(() -> {
            gui.clearPageItems();
            for (Warp warp : NaturalPlayerWarps.getDatabase().getRecentWarps(player)) {
