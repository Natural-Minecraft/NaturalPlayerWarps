...
public class EcoBitsHook implements CurrencyHook {
    ...
    public void setup() {
        ...
        if (currency == null) {
            Bukkit.getConsoleSender().sendMessage(StringUtils.formatToString("&#FF0000[NaturalPlayerWarps] EcoBits currency named &#DD0000" + internal + " &#FF0000not found! Change the currency-name or disable the hook to get rid of this warning!"));
        }
    }
